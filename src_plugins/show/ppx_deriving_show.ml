...
let impl_generator kind = Deriving.Generator.V2.make impl_args (fun ~ctxt (_, type_decls) with_path ->
  let path =
...
let intf_generator kind = Deriving.Generator.V2.make intf_args (fun ~ctxt:_ (_, type_decls) _with_path ->
