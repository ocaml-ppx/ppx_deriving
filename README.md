...
It is expected that all _deriving_ plugins will follow the same conventions, thus simplifying usage.
  ...
  * Base types are redefined in the Ppx_deriving_runtime module, and plugins as well as functions generated by the plugins should use these types whenever possible.
